                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-gray-600">
                                Modificar información de {{ provincia.nombre }}
                            </p>
                        </div>
                    </div>
                </div>
...
const form = useForm({
    nombre: props.provincia.nombre,
    codigo: props.provincia.codigo || '',
    observaciones: props.provincia.observaciones || '',
});
...
const submit = () => {
    ...
    form.put(`/provincias/${props.provincia.id}`, {
        onSuccess: () => {
